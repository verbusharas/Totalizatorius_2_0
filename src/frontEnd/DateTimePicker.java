...
public class DateTimePicker extends DatePicker {
    ...
    public DateTimePicker() {
        ...
        //ČIA YRA REIKŠMĖS tik DATOS. Pirmasis old buna null
        valueProperty().addListener((observable, oldValue, newValue) -> {
            System.out.println("OLD_a " + oldValue);
            System.out.println("NEW_a " + newValue);
            if (newValue == null) {
        ...
        //ČIA YRA REIKŠMĖS SU LAIKU. Pirmasis old buna "Now"
        ...
        getEditor().focusedProperty().addListener((observable, oldValue, newValue) -> {
            if (!newValue)
                System.out.println("bandymaz: " + valueProperty());
    ...
    private void simulateEnterPressed() {
        ...
        System.out.println("simuliacija2");
